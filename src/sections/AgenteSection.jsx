import { Clock, MessageSquareText, Sparkles, ArrowRight, MapPin, CalendarDays, Users, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <section id="agente" className="relative py-20 sm:py-28 bg-white overflow-hidden">
      ...
      <Container className="relative grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        {/* texto */}
        <div>
          <SectionBadge tone="coral">O Agente de IA</SectionBadge>
